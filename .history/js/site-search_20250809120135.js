    ...
    indexPageKeywords(page) {
        const keywordMaps = {
            'index.html': [
                ...
                'social behavior', 'cognition', 'field work'
            ],
            'people.html': [
                'principal investigator', 'graduate students', 'undergraduate students',
                'research team', 'faculty', 'lab members', 'staff'
            ],
            'research.html': [
                'research projects', 'methodology', 'equipment', 'facilities',
                'experiments', 'data analysis', 'scientific methods'
            ],
            'publications.html': [
            ...
            'gallery.html': [
                ...
                'team photos', 'facility images', 'visual gallery'
            ],
            'news.html': [
                'latest news', 'announcements', 'research updates',
                'achievements', 'events', 'press releases'
            ],
            'teaching.html': [
                'courses', 'curriculum', 'education', 'student mentoring',
                'classes', 'academic programs', 'instruction'
            ],
            'contact.html': [
                'contact information', 'office hours', 'location', 'address',
                'phone', 'email', 'directions', 'map'
            ]
        };
